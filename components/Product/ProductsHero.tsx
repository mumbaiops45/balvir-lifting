...
export default function ProductsHero() {
  ...
  return (
    ...
    >
      ...
      <div
        ref={bgRef}
        className="absolute inset-0 bg-gradient-to-br from-[#0e0406] via-dark-900 to-[#0a0a0a]"
      />
            {/* Background Image */}
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-10 pb-20 pt-36 w-full">
        <div ref={contentRef} className="max-w-3xl">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-extrabold text-white leading-[0.95] tracking-tight mb-7">
            Multi-Brand<br />
            <span className="text-blue-gradient">Product Catalogue</span>
          </h1>
          <p className="text-white/45 text-base md:text-lg leading-relaxed max-w-xl">
            A comprehensive range of elevator &amp; escalator accessories, steel wire ropes, LED
            lighting, cables and industrial automation products — sourced from leading global and
          ...
          <div className="flex flex-wrap gap-3 mt-9">
            {[
              ...
              <span key={b} className="border border-white/10 text-white/50 text-xs font-medium px-4 py-2">
                {b}
              </span>
            ))}
          </div>
