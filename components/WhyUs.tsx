...
const reasons = [
  {
    ...
    short: "One trusted source for many brands.",
    desc:
      "BALVIR LIFTING is among the leading suppliers of multi-brand electrical, electronics, mechanical and hardware products across industries.",
    metric: "Multi-Brand",
    metricSub: "Electrical · Electronics · Mechanical",
    tag: "Quality"
  },
  {
    ...
    short: "Sourced from leaders across the world.",
    desc:
      "We have developed long lasting relationships with top manufacturers and suppliers in India and worldwide.",
    metric: "Global",
    metricSub: "Trusted Manufacturer Network",
    tag: "Engineering"
  },
  {
    ...
    short: "A simple principle we live by.",
    desc:
      "We follow one simple principle, Earn Trust with Business, and focus on customer satisfaction.",
    metric: "Since 2014",
    metricSub: "Built on Trust",
    tag: "Reliability"
  },
  {
    ...
    short: "Stock and support nationwide.",
    desc:
      "We serve OEMs, contractors and industries across India with timely delivery.",
    metric: "Pan India",
    metricSub: "Major Metro Coverage",
    tag: "Service"
  },
  {
    num: "05",
    title: "Reliable & Affordable",
    short: "Best quality at fair prices.",
    desc:
      "We focus on delivering reliable products with latest technology at competitive pricing.",
    metric: "Best Value",
    metricSub: "Quality at Fair Prices",
    tag: "Value"
  },
  {
    num: "06",
    title: "Greener & Safer Products",
    short: "Better products for industry.",
    desc:
      "Our goal is to provide greener and safer industrial solutions for all users.",
    metric: "Greener & Safer",
    metricSub: "Sustainable Approach",
    tag: "Sustainability"
  }
];
...
export default function WhyUs() {
  ...
  useEffect(() => {
    reasons.forEach((_, i) => {
      ...
      if (i === active) {
        gsap.to(el, { height: "auto", opacity: 1, duration: 0.45 });
      } else {
        gsap.to(el, { height: 0, opacity: 0, duration: 0.3 });
      }
    });
  }, [active]);
  ...
  return (
    <section ref={sectionRef} className="bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div ref={headRef} className="pt-24 pb-14 border-b">
