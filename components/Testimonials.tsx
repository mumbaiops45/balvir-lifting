    ...
    <section ref={sectionRef} className="section-pad bg-white relative overflow-hidden ">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div ref={headRef} className="text-center mb-16">
          <p className="text-blue-600 text-xs font-bold uppercase tracking-[0.25em] mb-4">Client Stories</p>
          <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 leading-tight tracking-tight">
            What Our Clients <span className="text-blue-gradient">Say</span>
          </h2>
        </div>
        ...
        <div ref={cardsRef} className="grid md:grid-cols-2 gap-6">
          {testimonials.map(t => (
            <div key={t.name}
              className="group bg-white border border-gray-200 hover:border-blue-200 hover:shadow-[0_8px_40px_rgba(26,79,196,0.08)] p-8 transition-all duration-300 relative shadow-sm">
              {/* Animated top line */}
              <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-blue-600 to-transparent scale-x-0 group-hover:scale-x-100 transition-transform duration-500" />

              {/* Quote */}
              <div className="text-6xl font-serif text-blue-100 leading-none select-none mb-4">&ldquo;</div>
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-blue-600 flex items-center justify-center text-white font-bold text-sm shrink-0">
                  {t.init}
                </div>
                <div>
